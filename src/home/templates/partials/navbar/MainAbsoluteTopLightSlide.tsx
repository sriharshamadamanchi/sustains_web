...
export const MainAbsoluteTopLightSlide = () => (
  <header
    id = "header"
    className = "navbar navbar-expand-lg navbar-absolute-top navbar-show-hide navbar-dark"
          ...
          <div className = "navbar-absolute-top-scroller">
            <ul className = "navbar-nav nav-pills">
              ...
              <li className = "nav-item ms-lg-auto">
                <a
                  className = "btn btn-ghost-light me-2 me-lg-0"
